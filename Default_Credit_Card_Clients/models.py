...
# fitting the model
    ...
    pickle.dump(knn, open(filename, 'wb'),protocol = 2)
...
# fitting the model
    ...
    pickle.dump(lr, open(filename, 'wb'),protocol = 2)
...
# fitting the model
    ...
    pickle.dump(bnb, open(filename, 'wb'),protocol = 2)
...
# fitting the model
    ...
    pickle.dump(extr, open(filename, 'wb'),protocol = 2)
